...
h1.setAttribute('class', 'amarillo'); //cambiamos el atributo en este caso la clase
h1.classList.add('verde'); //agrega esto a la clase
h1.classList.remove('amarillo'); //elimina este elemento de la clase

input.value='234';

const img = document.createElement('img') //Nos ayuda a crear el elemto html que querramos
img.setAttribute('src', 'https://evitarquesatanas.com/wp-content/uploads/2019/06/Jesus-name-powerful-2.jpg');
console.log(img);

pid.innerHTML=""; 
pid.append(img); //agrega el elemento despues del contenido